...
-   [Übersicht Arbeiten mit R](https://www.datacamp.com/de/tutorial/category/r-programming): R-Tutorials und Hilfestellungen für spezifische Probleme

## KI-Unterstützung bei der Arbeit mit R

::: callout-warning

Wichtig: Bei der Verwendung von KI-Hilfsmitteln muss in einem Verzeichnis detaillilert gekennzeichnet werden, welche Hilfsmittel wofür verwendet wurden. Mehr Informationen gibt es in @sec-ki-tools.
...
4.  Bei Tools wie ChatGPT oder Hawki:
...
### Verschiedene KI-Tools im Überblick: Einsatz von Co-Pilot, ChatGPT und Hawki
...
-   GitHub Konto: die Nutzung mit einem [Studierendenkonto](https://docs.github.com/de/education/explore-the-benefits-of-teaching-and-learning-with-github-education/github-education-for-students/apply-to-github-education-as-a-student) ist kostenlos

    1.  Wechseln Sie zu GitHub Education
    2.  Wählen Sie unter „Select your role in education“ die Option "Student" aus
    3.  Geben Sie im Dialogfeld „Application“ den Namen der Bildungseinrichtung ein
    4.  Wählen Sie bei Bedarf die E-Mail-Adresse aus, die für die Bildungseinrichtung verwendet wird, oder fügen Sie diese hinzu
    5.  Klicken Sie auf "Weiter". Es folgt die Aufforderung einen Nachweis des akademischen Status hochzuladen, beispielsweise ein Bild des Studierendenausweises
...
-   Co-Pilot Integration in der eigenen R Anwendung
...
Für beispielhafte Anwendungen und weitere Tipps, siehe die [Co-Pilot Guidelines](https://docs.posit.co/ide/user/ide/guide/tools/copilot.html)
...
-   Anmeldung mit IdM-Kennung: ein eigener Account bei nutzbaren KI-Anwendungen ist nicht notwendig

-   Kostenlos: die Kosten werden von der FAU getragen
...
Bei Hawki kann man generell immer zwischen den verschiedenen verwendbaren Modellen, wie z.B. ChatGPT 4, DeepSeek oder Qwen wählen und auch wechseln. Diese können für alle oben genannten Anwendungen genutzt werden und reichen vom Erlernen von Prompts in Lernräumen bis hin zu Chaträumen. Bei den Lernräumen gibt es die Unterkategorien „Wissenschaftliches Arbeiten“, „Organisation“ und „Kreativität“. „Wissenschaftliches Arbeiten“ ist für die Arbeit mit R interessant, da es in weitere Bereiche wie „Datenanalyse“ unterteilt ist.

Ein beispielhafter Prompt hierfür lautet: „Ich habe kürzlich eine umfangreiche Datensammlung durchgeführt und suche nun nach Unterstützung bei der Analyse der Daten. Die Datensammlung umfasst \[Beschreibung der Daten\], und ich möchte \[Ziel der Analyse\]. Könntest du mir bitte dabei helfen, die Daten zu analysieren und mir Ratschläge zur Interpretation der Ergebnisse geben?“
...
Vorteile der Nutzung von KI-Tools sind vor allem die guten Hilfestellungen durch Codevorschläge und die schnelle Beantwortung einfacher Fragen. Dennoch scheitern diese Tools meist noch an komplexeren Aufgaben oder beim Übersetzen in unterschiedliche Programmiersprachen.
