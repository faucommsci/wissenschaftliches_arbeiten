...
Wir empfehlen in wissenschaftlichen Arbeiten vorurteilsfreie, geschlechtergerechte Sprache. Im Rahmen kommunikations- und sozialwissenschaftlicher Forschung beschäftigen wir uns mit Menschen mit einer Vielfalt von (Geschlechts-)Identitäten, daher ist es wichtig, diese Realität auch in wissenschaftlichen Arbeiten zu reflektieren und zu respektieren. Dies umfasst unter anderem:

-   Geschlechtergerechte Sprache, z. B. *Autor\*innen* statt Autoren

-   Vorurteilsfreie Sprache, z. B. sollten keine Adjektive als Nomen für die Beschreibung von Personen(-gruppen) verwendet werden

-   Hierarchisieren Sie keine Unterschiede zwischen Menschen, z. B. indem Sie gesellschaftlich dominante Gruppen in einer Abbildung über anderen Gruppen positionieren
...
![Beispieldeckblatt \| [[Beispielvorlage als .docx-Datei herunterladen](templates/title_page_template.docx)]{.download}](img/title_page_template){#fig-vorlage_deckblatt fig-align="center" width="66%"}

Das Deckblatt sollte folgende Informationen enthalten

-   Name der Universität, des Fachbereichs und des Lehrstuhls
...
In particular, I am aware that the use of artificial intelligence is forbidden unless its use as an aid has been expressly permitted by the examiner. This applies in particular to such programs that could process the task of the examination or parts thereof instead of me, for example chatbots (especially ChatGPT) and other methods suitable for this purpose. I include a detailed overview of all used artificial intelligence tools and how I used them in an appendix.
...
## KI-Tools {#sec-ki-tools}

Die Nutzung von KI-Tools muss von Ihrer Prüferin bzw. Ihrem Prüfer genehmigt werden. Gegebenenfalls wird je nach Anwendungszweck der KI entschieden. In jedem Fall muss die Seminar- oder Abschlussarbeit eine **eidesstattliche Erklärung** enthalten, die ausweist, ob KI-Tools genutzt wurden oder nicht.
Sofern KI-Tools genutzt wurden, ist eine Tabelle mit den verwendeten Tools beizufügen. Bitte fügen Sie folgende Spalten in die Tabelle ein: KI-Tool (z. B. ChatGPT, Hawki), Nutzungszweck (z. B. Rechtschreibprüfung, Analysecode verbessern), Begründung für die Nutzung (z. B. Lesbarkeit verbessern, Fehlermeldungen in R analysieren) und Anwendungsbereiche (z. B. S. 2, Abbildung 3, Kapitel 4.1). Die Tabelle kann beispielsweise so aussehen:

| KI-Tool         | Nutzungszweck            | Begründung für die Nutzung           | Anwendungsbereiche            |
|-----------------|--------------------------|--------------------------------------|-------------------------------|
| ChatGPT         | Analyse-Code verbessern  | Fehlermeldungen analysieren          | Ausschließlich in der Analyse |
| DeepL Write     | Formulierungsvorschläge  | Verbesserung der Lesbarkeit          | Gesamte Arbeit                |
| NotebookLM      | Erklärungen              | Verständnis von Konstrukten erlangen | Konstrukte: X, Y, Z           |
| DeepL Translate | Übersetzungen            | Skalen für Fragebogen übersetzen     | Skalen: A, B, C               |

: Beispielhafte Tabelle für die Nutzung von KI-Tools {#tbl-ki-tools}

::: callout-caution
## Hinweis

Abschnitte oder ganze Texte generieren zu lassen und zu verwenden ist ein Plagiat!
:::

::: callout-caution
## Achtung

Löschen Sie Ihre Chats mit den entsprechenden KI-Tools nicht. Sollten Zweifel hinsichtlich der Legitimität der KI-Nutzung auftreten, können Sie dazu aufgefordert werden, Ihre Chatdateien einzureichen. Dieser Aufforderung müssen Sie nachkommen! 
:::