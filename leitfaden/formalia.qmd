...
Ihre wissenschaftliche Arbeit sollte ein Deckblatt haben (für ein Beispiel siehe @fig-vorlage_deckblatt; [ [Beispielvorlage als .dotx-Datei herunterladen](templates/title_page_template.dotx)]{.download})

![Beispieldeckblatt](img/vorlage_deckblatt){#fig-vorlage_deckblatt fig-align="center" width="66%"}
