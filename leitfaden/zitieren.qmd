...
::: callout-important
*Abweichend von den APA-Richtlinien erwarten wir, dass Sie in Kurzbelegen bei allen Arbeiten, Bachelor-, Master-, und Seminararbeiten, Seitenzahlen angeben* (s. [Abschnitt @sec-indirect]). Ausgenommen hiervon sind Verweise auf einen gesamten Beitrag oder das ungefähre Thema.
:::
...
Sprache: In Deutschen Arbeiten dürfen Sie grundsätzlich auf Deutsch oder Englisch zitieren, z. B. Hrsg. vs. Eds., oder S. 4 vs. p. 4. Wir empfehlen die englische APA7-Schreibweise aufgrund der weiter verbreiteten Integration in Zitationsprogrammen. In englischen Arbeiten sollten Sie auf Englisch zitieren. Titel, Publikationsnamen, etc. werden nicht übersetzt.

Im Folgenden finden Sie eine Kurzanleitung[^zitieren-1]. **Wichtig**: Sie können diesen Abschnitt als Nachschlagewerk nutzen, müssen ihn aber nicht vollständig durcharbeiten.

[^zitieren-1]: Die Anleitung zum Zitieren basiert auf einem Kurz-Manual, das vom [Lehrstuhl Medienwirkung & Medienpsychologie](https://www.medienpsychologie.ifp.uni-mainz.de/) an der JGU Mainz (Prof. Dr. Leonard Reinecke) erstellt wurde. Besonderer Dank gebührt Alicia Ernst, Alicia Gilbert und Anisha Arenz.
...
-   Wenn das Buch keine DOI besitzt und ein eBook einer wissenschaftlichen Datenbank ist, endet die Literaturangabe nach dem Verlagsnamen. Nennen Sie keine Datenbankinformationen. Die Literaturangabe gleicht dann der von Printausgaben.

-   Wenn ein Buch 20 Autor\*innen oder weniger besitzt, nennen Sie alle Autor\*innen. Wenn ein Buch 21 Autor\*innen oder mehr besitzt, nennen Sie die ersten 19 Autor\*innen, setzen Sie danach drei Punkte („...") und nennen Sie danach den Namen des letzten Autors oder der letzten Autorin. Diese Regel gilt auch für Zeitschriftenartikel (s. [Abschnitt @sec-fachzeitschriften)]).
...
-   Wenn der Zeitschriftenaufsatz eine Artikelnummer (z.B. e12345678) anstelle einer Seitenangabe hat, nennen Sie das Wort „Artikel" und folgend die Artikelnummer.

-   Wenn ein Zeitschriftenartikel 20 Autor\*innen oder weniger besitzt, nennen Sie alle Autor\*innen. Wenn ein Artikel 21 Autor\*innen oder mehr besitzt, nennen Sie die ersten 19 Autor\*innen, setzen Sie danach drei Punkte („...") und nennen Sie danach den Namen des letzten Autors oder der letzten Autorin. Diese Regel gilt auch für Bücher (s. [Abschnitt @sec-bücher-und-ebooks]).
...
-   Sortierung:
    ...
    -   Gibt es Werke mit gleicher Erstautorin/gleichem Erstautor, aber unterschiedlichem Jahr und unterschiedlicher Zweitautorin/unterschiedlichem Zweitautor, wird zunächst alphabetisch nach dem Anfangsbuchstaben des Zweitautors oder der Zweitautorin (und danach chronologisch) sortiert. Wenn auch der zweite Nachname gleich ist, wird nach dem dritten sortiert, usw.:
...
-   Wenn mehrere Quellen mit drei oder mehr Autor\*innen und demselben Publikationsjahr zu demselben Kurzbeleg (Name et al., Jahr) zusammengefasst werden würden, werden so viele Autoren genannt bis die Quelle eindeutig zuordenbar ist.
...
-   Wenn sich nur der letzte Autor\*innenname unterscheidet, nennen Sie alle Namen vollständig bei jeder Quellenangabe.
...
-   Wenn die Erstautor\*innen mehrerer Quellen denselben Nachnamen haben, aber verschiedene Initialen, nennen Sie die Initialen des Erstautors oder der Erstautorin in allen Kurzbelegen im Text, auch wenn sich das Publikationsjahr unterscheidet.
...
-   Um auf eine spezifische Stelle einer Quelle im Text zu verweisen, nennen Sie Autor\*in, Jahr und eine Information über die bestimmte Stelle. Dies können Seiten, Tabellen, Schaubilder, Ergänzungsmaterial, Fußnoten, Kapitel, Zeitstempel, o. Ä. sein, z. B.
...
-   Bei einem indirekten Zitat (d.h. einer sinngemäßen Wiedergabe von Textstellen) setzen Sie immer Kurzbelege. Seitenangaben sind dabei vor allem angemessen, wenn spezifische Stellen einer Quelle belegt werden sollen. 

    -   Der Third-Person Effekt (Davison, 1983) beschreibt eine indirekte Medienwirkung. Gemeint ist damit insbesondere die Wahrnehmung, dass Massenmedien auf andere Personen einen größeren (negativen) Einfluss haben, als auf einen selbst (Davison, 1983, pp. 2-3).

::: callout-important
**APA-Abweichung**: 

Sie sollten bei allen allen Arbeiten - Bachelor-, Master-, und Seminararbeiten - durchgehend Seitenangaben in Kurzbelegen verwenden. Wird nur auf das grundlegende Thema eines Aufsatzes verwiesen, muss keine Seitenzahl angegeben werden.
:::
...
-   Grammatikalische Fehler im Original-Zitat werden übernommen und mit \[sic\] (d.h. „genau so") markiert.
    ...
    -   „Die Psychoanalyse macht eine Grundvoraußetzung \[sic\], deren Diskussion philosophischem Denken vorbehalten bleibt, deren Rechtfertigung in ihren Resultaten liegt" (Freud, 1914, p. 11).
...
[Kursivsetzung wurde hier außen vor gelassen.]{.notes}
