...
![Ablauf einer Bachelorarbeit an Lehrstuhl und Juniorprofessur für Kommunikationswissenschaft](img/ablauf.svg){#fig-ablauf fig-alt="Grafik, die den üblichem Ablauf einer Bachelorarbeit zeigt. In der ersten Phase, der Bewerbungsphase, steht: Themenbereich(e) suchen, Abstract(s) vorbereiten, Bewerbung einreichen und Rückmeldung abwarten. In der zweiten Phase, \"Planung\", steht Seminar wiss. Arbeiten, Ausarbeitung: Thema & Methode, Abgabe Exposé, und Teilnahme am Kolloquium. In der dritten Phase, \"Bearbeitung\", steht Anmerldung der BA, Umsetzung der Methode, Ausarbeitung der BA und Abgabe nach 9 Wochen." fig-align="center"}

### Deadlines, Bewerbung, Vergabe der Themen

Aktuelle Informationen zur Bewerbung, Themenvergabe, Anmeldung und Abgabe entnehmen Sie bitte der Website des Lehrstuhls für Kommunikationswissenschaft. In @fig-ablauf finden Sie einen Überblick über den Ablauf.
...
[^1]: Sie müssen dabei keine Rücksicht auf grammatische Konformität nehmen.
...
Ihre wissenschaftliche Arbeit sollte ein Deckblatt haben (für ein Beispiel siehe @fig-vorlage_deckblatt, [Link zur .dotx-Vorlage](templates/title_page_template.dotx))

[![Beispieldeckblatt](img/vorlage_deckblatt.svg){#fig-vorlage_deckblatt fig-alt="Beispieldeckblatt für eine Seminararbeit am Lehrstuhl für Kommunikationswissenschaft. Das Deckblatt enthält Seminartitel, Semester, Name Dozent*in, Name Student*in, Matrikelnummer, Studiengang, Studiensemester, Anschrift, Telefonnummer, und E-Mail-Adresse." fig-align="center" width="66%"}](/templates/title_page_template.dotx)
...
Der Methodik-Abschnitt sollte Lesende dazu in die Lage versetzen, Ihre Arbeit zu reproduzieren. Das beinhaltet beispielsweise die transparente Darstellung von **Such-, Einschluss und Ausschlusskriterien** bei einem Literaturüberblick und die Beschreibung der **Stichprobe**, verwendeter **Materialien** und des **Vorgehen**s bei empirischen Arbeiten.
