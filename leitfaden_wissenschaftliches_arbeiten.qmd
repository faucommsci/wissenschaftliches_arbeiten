...
format: 
  html:
    ...
    link-external-filter: '^(?P<protocol>[a-z\-]+)?:?(?P<host>\/\/+faucommsci.github.io.*\.[^\/]+)$'
...
![Beispieldeckblatt](img/vorlage_deckblatt.svg){#fig-vorlage_deckblatt fig-align="center" width="66%"}
