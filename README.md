...
- Rendering:
    ...
    - In Visual Studio Code, Clone this repository, open the folder and write `Set-Location -Path leitfaden` (Windows) or `cd leitfaden` (Linux, MacOS) in the terminal. This will set the correct path and allows to use the render command above.
